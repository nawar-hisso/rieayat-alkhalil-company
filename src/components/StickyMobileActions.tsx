...
export function StickyMobileActions({ dict }: { dict: Dictionary }) {
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 flex border-t border-border-warm bg-pearl/95 backdrop-blur-md md:hidden">
      <Link
        href={simpleWhatsappUrl()}
        target="_blank"
        rel="noopener noreferrer"
        className="flex flex-1 items-center justify-center gap-2 border-e border-border-warm py-3.5 text-sm font-semibold text-charcoal"
      >
